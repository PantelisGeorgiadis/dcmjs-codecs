...
expectError(NativeCodecs.decodeJpegXl('1'));
expectError(NativeCodecs.decodeJpegXl(context1, '2'));
expectError(NativeCodecs.encodeJpegXl('1'));
expectError(NativeCodecs.encodeJpegXl(context1, '2'));
